...
export class GradientService {
  constructor() {}
   ...
   calculoGradientAritCre(option: string, VP:number, pcuota: number, Ti: number, N: number, gradiente: number, cuotaI: number): any {
    let A = pcuota;
    let i = Ti;
    let n = N;
    let G = gradiente;
   ...
   calculoGradientAritDec(option: string, VP:number, pcuota: number, Ti: number, N: number, gradiente: number, cuotaI: number): any {
    let A = pcuota;
    let i = Ti;
    let n = N;
    let G = gradiente;
   ...
   calculoGradientGeoCre(option: string, VP:number, pcuota: number, Ti: number, N: number, gradiente: number, cuotaI: number):any {
    let A = pcuota;
    let i = Ti;
    let n = N;
    let G = gradiente;
   ...
   calculoGradientGeoDec(option: string, VP:number, pcuota: number, Ti: number, N: number, gradiente: number, cuotaI: number): any {
      let A = pcuota;
      let i = Ti;
      let n = N;
      let G = gradiente;
